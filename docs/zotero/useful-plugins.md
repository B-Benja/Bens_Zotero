...
**Location of Files**  
 Change to Custom Location and use **the same path** as for Links Attachment Base Directory! ([changed in previous chapter](/zotero/syncing/))
...
A Plugin for better Latex support ([already discussed in a previous chapter](/zotero/adding-citations/))
