...
In this tab, you can specify how to rename your documents on your harddrive. So that they are conveniently named outside of Zotero.
...
Afterwards, you can delete the original document from your download folder (or whereever you initially saved it).
...
The add-on automatically fetches the numbers of citations of your Zotero items from Google Scholar and makes it possible to sort your items accordingly. Not  really useful, but it is kinda cool (I like webscraping, don't hate me!).
